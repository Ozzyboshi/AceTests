...
noresetanglew2:
	...
	STROKE #1
	LINE_Q_10_6 #160*64,#0*64,#160*64,#255*64
	LINE_Q_10_6 #0*64,#128*64,#319*64,#128*64
	...
	LINE_Q_10_6 #-50*64,#-5*64,d7,#-5*64
	LINE_Q_10_6 #-50*64,#-6*64,d7,#-6*64

	LINE_Q_10_6 #-50*64,#-3*64,d7,#-3*64
	LINE_Q_10_6 #-50*64,#-4*64,d7,#-4*64

	LINE_Q_10_6 #-50*64,#-1*64,d7,#-1*64
	LINE_Q_10_6 #-50*64,#-2*64,d7,#-2*64

	LINE_Q_10_6 #-50*64,0*64,d7,0*64
	LINE_Q_10_6 #-50*64,#1*64,d7,#1*64
	LINE_Q_10_6 #-50*64,#2*64,d7,#2*64
	...
	RESET_CURRENT_TRANFORMATION_MATRIX_Q_10_6
	TRANSLATE_INV_Q_10_6 #190*64,#158*64
	move.w ANGLE,d7
	lsr #1,d7
	;add.w #$0040,d7
	SHEARX_INV_Q_10_6 d7
	
	STROKE #3
	TRIANGLE_Q_10_6 #0*64,#00*64,#0*64,#25*64,#25*64,#25*64
